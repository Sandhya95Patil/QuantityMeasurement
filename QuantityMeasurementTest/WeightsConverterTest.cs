...
namespace QuantityMeasurementTest
{
    ...
    public class WeightsConverterTest
    {
        ...
        /// </summary>
        [Test]
        public void One_Tonne_And_Thousand_KGs_Should_Equal_Two_Tonne()
        {
            double oneTonne = weightsConverter.WeightConverter(QuantityEnums.TONNE, 1);
            double kgsToTonne = weightsConverter.WeightConverter(QuantityEnums.KILOGRAM_TO_TONNE, 1000);
            double addValues = addTwoValue.AddTwoValue(oneTonne, kgsToTonne);
            Assert.AreEqual(expected:2, addValues);
        }
    }
}
